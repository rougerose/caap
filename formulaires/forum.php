 ...
 * @return array|bool
 */
function formulaires_forum_charger($objet, $id_objet, $id_forum,$ajouter_mot, $ajouter_groupe, $afficher_previsu, $retour){
   // plugin caap : début surcharge
   // si pas d'id_forum : on récupère le titre saisi par le visiteur. Sinon c'est celui de la discussion en cours.
   if (!$id_forum) {
      $titre = _request('titre');
   }
   else {
      if (!function_exists($f = 'forum_recuperer_titre')) {$f = 'forum_recuperer_titre_dist';}
      if (!$titre = $f($objet, $id_objet, $id_forum))
         return false;
   }
   // plugin caap : fin surcharge
 ...
 * @return array|bool
 */
function formulaires_forum_verifier($objet, $id_objet, $id_forum,
 ...
 * @return array|bool
 */
function formulaires_forum_traiter($objet, $id_objet, $id_forum,
                                        $ajouter_mot, $ajouter_groupe, $afficher_previsu, $retour){
