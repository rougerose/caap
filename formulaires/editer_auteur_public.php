...
function formulaires_editer_auteur_public_charger_dist($id_auteur='new', $retour='', $associer_objet='', $config_fonc='auteurs_edit_config', $row=array(), $hidden=''){
...
// http://doc.spip.org/@inc_editer_mot_dist
function formulaires_editer_auteur_public_traiter_dist($id_auteur='new', $retour='', $associer_objet='', $config_fonc='auteurs_edit_config', $row=array(), $hidden=''){
   ...
   $res['redirect'] = parametre_url($res['redirect'],"modification","ok",'&');
